...
const MYSQL_USER = process.env.MYSQL_USER || 'autumnus'
const MYSQL_PASSWORD = process.env.MYSQL_PASSWORD || 'autumnus'
const MYSQL_DATABASE = process.env.MYSQL_DATABASE || 'autumnus'
